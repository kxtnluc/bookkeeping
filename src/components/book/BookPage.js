...
import { Box, Button, InputLabel, MenuItem, Rating, Select, Stack, StyledEngineProvider, Typography, useRadioGroup } from "@mui/material"
                ...
                <article className="bp-cover-rating-container">
                    ...
                    <div className="bp-rating">
                        <StyledEngineProvider injectFirst>
                            <Stack spacing={1}>
                                <Rating className="bp-rating-2" name="half-rating-read" size="large" defaultValue={5} precision={0.5} readOnly />
                            </Stack>
